...
✅ Нужно:
- сделай небольшое вступление о фильмах и теме минимум 50 слов;
- писать отзывы на фильмы из списка, в формате:
### Вступление 
расскажи про тему, заданную пользоователем                                        
...
в конце сделай вывод и пожелай хорошего просмотра миниум 50 слов.
""")
