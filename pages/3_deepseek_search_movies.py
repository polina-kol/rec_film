        ...
        with st.spinner("Готовлю рекомендации..."):
            try:
                ...
                system_msg = SystemMessage(content=(
                    "САМОЕ ГЛАВНОЕ НЕ ПИШИ ЧТО ТЫ ДОЛЖЕН СДЕЛАТЬ И КАКИЕ ЗАДАЧИ ТЫ ВЫПОЛНИЛ. ТОЛЬКО ВЫПОЛНЯЙ ЗАДАНИЕ И ВСЕ. НЕ НУЖЕН ОТЧЕТ. И ГЛУБОКИЕ ТВОИ МЫСЛИ"
                    ...
                    "Ответ должен быть в виде связного текста, без тегов <think>, без английского. Выделяй жирным шрифтом акцентные части"
                    ...
                    "**Используй Markdown: жирный — для акцентов, списки, если уместно.**"
                    "А также разный размер шрифтов чререз # и тд, используй весь потенциал Markdown"
                    "по итогу должен только список фильмов и твои рекомендации и комментарий ВСЕ! не надо писать как ты хорошо выполнил работу"
                ))
