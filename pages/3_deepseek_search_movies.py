    ...
    if not user_query.strip():
        ...
        with st.spinner("Готовлю рекомендации..."):
            try:
                ...
                **Никаких размышлений о том, что тебе нужно сделать. Просто делай!**  
                **Не пиши отчёты, не пиши объяснений задания, не рассказывай о своих действиях.**

                Дай короткий, остроумный и полезный отзыв по каждому фильму из списка, затем добавь рекомендации от себя по запросу пользователя.  
                Формат:

                - Используй **Markdown**: `#` для заголовков, `**жирный текст**` для акцентов, списки, если уместно.
                - Не используй HTML, не используй <think> или английский.
                - Итог — только фильмы и рекомендации. Всё. Никаких лирических отступлений.
                """)
