        ...
        with st.spinner("Готовлю рекомендации..."):
            try:
                ...
                system_msg = SystemMessage(content=(
                    ...
                    "Ответ должен быть в виде связного текста, без тегов <think>, без HTML, без английского. Не надо писать какой ответ должен быть и чтобы пользователь тебя попрочил сразу начинай давать рекомендации и объяснять"
                ))
